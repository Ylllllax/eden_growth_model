...
class All():
    ...
    def test(self):
        ...
        while running:
            ...
            if self.counter % 1 == 0 and self.pause == 0:
                self.newParticle()
...
if __name__ == '__main__':
    ...
    np.savetxt("FIXEDoff-lattice-size800-8-results_" + ti + ".txt", np.transpose(results_list))
    np.savetxt("FIXEDoff-lattice-size800-8-results_time_" + ti + ".txt", np.transpose(results_time_list))
