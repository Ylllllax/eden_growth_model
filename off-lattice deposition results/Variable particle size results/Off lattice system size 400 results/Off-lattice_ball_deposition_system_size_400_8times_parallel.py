...
if __name__ == '__main__':
    ...
    np.savetxt("off-lattice-size400-8-results_" + ti + ".txt", np.transpose(results_list))
    np.savetxt("off-lattice-size400-8-results_time_" + ti + ".txt", np.transpose(results_time_list))
